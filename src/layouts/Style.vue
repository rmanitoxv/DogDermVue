...
/* .recoveracc__img, .recoveracc__img img
  {
    display: none;
  } */
...
.indiv-page-container {
    border-radius: 15px;
    box-shadow: rgba(149, 157, 165, 0.253) 0px 5px 10px;
}
...
@media only screen and (max-width: 600px) {
    ...
    .content-container {
        ...
        border-radius: 20px;
        padding: 50px;
        box-shadow: rgba(149, 157, 165, 0.281) 0px 8px 24px;
    }
